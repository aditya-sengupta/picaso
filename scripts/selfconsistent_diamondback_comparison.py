...
# %%
for (c, teff) in zip(["xkcd:bright blue", "xkcd:turquoise", "xkcd:olive green"], [900, 1300, 2400]):
    ...
    plt.semilogy(temp, pressure_grid, label=f"{teff} d'back", c=c)
    if teff > 900:
        plt.semilogy(out_d[teff]["temperature"], out["pressure"], label=f"{teff} PICASO", ls="--", c=c)
