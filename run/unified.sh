...
mpiexec --bind-to core --map-by core -n 640 /home/adityars/anaconda3/envs/mpitest/bin/python scripts/unified.py fine cloudless partial no_rerun # full cloudless grid, finer but with less information
