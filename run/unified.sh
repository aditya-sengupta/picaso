...
#SBATCH --ntasks=240                  # Number of MPI ranks
...
module load python
module load openmpi
mpiexec -n 240 /home/adityars/anaconda3/envs/mpitest/bin/python scripts/unified.py coarse cloudless unirradiated full rerun # Bobcat match
mpiexec -n 240 /home/adityars/anaconda3/envs/mpitest/bin/python scripts/unified.py coarse cloudless irradiated full rerun # Mukherjee+26 match
