...
module load python
module load openmpi
mpiexec --bind-to core --map-by core -n 320 /home/adityars/anaconda3/envs/mpitest/bin/python -m mpi4py scripts/unified.py coarse cloudless irradiated full outlier # Mukherjee+26 and Bobcat match
mpiexec --bind-to core --map-by core -n 320 /home/adityars/anaconda3/envs/mpitest/bin/python -m mpi4py scripts/unified.py fine cloudless irradiated partial outlier # full cloudless grid, finer but with less information
