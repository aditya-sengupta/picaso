#!/bin/bash
#SBATCH --job-name=cloudless_irradiated      # Job name
...
#SBATCH --output=cloudless_irradiated_%j.log     # Standard output and error log

pwd; hostname; date

echo "starting"
module load python
/home/adityars/anaconda3/envs/picaso4/bin/python scripts/cloudless_irradiated_from_kazumasa.py
